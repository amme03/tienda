...
const ItemCatalogo = (
    ...
    <TouchableHighlight onPress={()=>props.navigation.navigate('CatalogoScreen')}
    underlayColor="#ccc">
    <View style={styles.container}>
        <View>
            <Image
             style={styles.image}
             source={{uri:props.article.photo}}></Image>
        </View>
        <View  style={styles.content}>
            <Text style={styles.articleName}>{props.article.name}</Text>
            <Text style={styles.articlePrice}>{props.article.price}</Text>
            <Text style={styles.articlePrice}>{props.article.cantidad}</Text>
        </View>
